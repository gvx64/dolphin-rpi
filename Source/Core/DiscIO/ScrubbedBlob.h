...
public:
  ...
  bool IsDataSizeAccurate() const override { return m_blob_reader->IsDataSizeAccurate(); } //gvx64 rollforward to 5.0-12188 - implement .rvz support

  u64 GetBlockSize() const override { return m_blob_reader->GetBlockSize(); } //gvx64 rollforward to 5.0-12188 - implement .rvz support
  bool HasFastRandomAccessInBlock() const override //gvx64 rollforward to 5.0-12188 - implement .rvz support
  {
    return m_blob_reader->HasFastRandomAccessInBlock(); //gvx64 rollforward to 5.0-12188 - implement .rvz support
  }
