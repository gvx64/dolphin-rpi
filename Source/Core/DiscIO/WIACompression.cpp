...
#include <optional>
#include <vector>
#include <limits> //gvx64 rollforward to 5.0-12188 - implement .rvz support
...
//gvx64  ASSERT_MSG(DISCIO, m_bytes_written == 0,
  _assert_msg_(LogTypes::DISCIO, m_bytes_written == 0, //gvx64 rollforward to 5.0-12188 - implement .rvz support
...
//gvx64  ASSERT(m_bytes_written <= m_buffer.size());
  _assert_(m_bytes_written <= m_buffer.size()); //gvx64 rollforward to 5.0-12188 - implement .rvz support
...
{
//gvx64  ASSERT_MSG(DISCIO, m_stream.state == nullptr,
  _assert_msg_(LogTypes::DISCIO, m_stream.state == nullptr, //gvx64 rollforward to 5.0-12188 - implement .rvz support
                               ...
                               u8* compressor_data_size_out)
{
  ...
  if (!lzma2)
  {
    ...
    {
//gvx64      ASSERT(m_options.lc < 9);
      _assert_(m_options.lc < 9);//gvx64 rollforward to 5.0-12188 - implement .rvz support
//gvx64      ASSERT(m_options.lp < 5);
      _assert_(m_options.lp < 5);//gvx64 rollforward to 5.0-12188 - implement .rvz support
//gvx64      ASSERT(m_options.pb < 5);
      _assert_(m_options.pb < 5); //gvx64 rollforward to 5.0-12188 - implement .rvz support
