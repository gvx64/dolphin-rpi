...
//gvx64  explicit WiiEncryptionCache(BlobReader* blob);
  explicit WiiEncryptionCache(BlobReader* blob) {}; //gvx64 - RVZ support resolves undefined reference error
//gvx64  ~WiiEncryptionCache();
  ~WiiEncryptionCache() {}; //gvx64 - RVZ support resolves undefined reference to class destructor error
...
//gvx64                     const HashExceptionCallback& hash_exception_callback = {});
                     const HashExceptionCallback& hash_exception_callback = {}) {}; //gvx64 - RVZ support resolves undefined reference error
